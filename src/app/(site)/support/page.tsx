...
export default function SupportPage() {
  return (
    <div id="support">
          ...
          <div className="s-inner">
            <div className="s-content">
              ...
              <div className="s-buttons">
                ...
                <a href="mailto:support@payjustnow.com" className="btn btn-outline-dark btn-md">
                  <span className="btn-fill"></span>
      ...
      <section className="section section-pad-top section-assistance" id="faq">
        <div className="container-sm">
          <div className="s-inner">
            <div className="s-content">
              <div className="s-title-wrapper">
                <h2 className="s-title">Your Questions answered</h2>
                <Link href="/faqs" className="btn btn-light btn-md">
                  <span className="btn-fill"></span>
