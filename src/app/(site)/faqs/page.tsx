...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <>
        <p>Visit payjustnow.com and follow the simple 6-step process to sign-up.</p>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <p>If your favourite online store does not have PayJustNow please add your voice to why they should <a href="#">here</a>. We'll hear you loud and clear and sing along with you!</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <p>Check out our list of <a href="#">Stores</a> for retailers using PayJustNow. We update this on a regular basis as new merchants come onboard.</p>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <p>Remember we don't make money when our shoppers don't pay and we reward good repayment behaviour over time, so keep your account up to date or even better, use a cash flow tool to get to the next pay day and settle early. If you are unable to meet your repayment commitment, please contact us on <a href="mailto:support@payjustnow.com">support@payjustnow.com</a></p>
      </>
    ),
  },
  {
